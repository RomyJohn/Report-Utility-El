...
def editPDF(tempFolderPath, tpr, ipr, pid, name, operator, clinicId):
    try:
        ...
        for item in pdfFilesList:
            ...
            if(item == pdf7):
                ...
                if(clinicType != 5 and (logoRequired=='Y' or logoRequired=='y')):
...
def mergePDFs(tempFolderPath, caseName, finalReportPath):
    try:
...
for caseNumber in range(0,sourceFolderTotalDir):
    ...
    <body>
        ...
        <div>
            ...
            '''+str(div4)+'''
            <br/><br/><br/>
            <p style='font-size:28px;color:#54BDE3;line-height:150%;'>Do reach out to our team if you have any further questions and we’d be happy to have our executives speak to you. Have a great day, and remember, <span style='color:#F58320;'> keep smiling.</span></p>
            <br/>'''
    if(int(pid[6]) != 5 and (logoRequired=='Y' or logoRequired=='y')):
    ...
    editPDF(tempFolderPath, tpr, ipr, pid, name, operator, clinicId)
    mergePDFs(tempFolderPath, caseName, finalReportPath)
    ...
    createVideoThumbnail(tempFolderPath, caseName, pid, aligners, operator, logoRequired)
    ...
    addTextToVideo(tempFolderPath, finalReportPath, caseName, pid, aligners, logoRequired)
